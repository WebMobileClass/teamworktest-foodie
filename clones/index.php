...
if(count($_POST)>0) {
  ...
  elif ($_POST['registersubmit']) {
    $send = mysqli_query($link,"INSERT INTO user_list (username,email, password ) VALUES
    ('" . $_POST["rusername"] . "',  '" . $_POST["remail"] . "','" . md5($_POST["rpassword"]) . "'");
